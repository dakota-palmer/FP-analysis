...
for name, group in groups:
    ...
    dfTidy.loc[group.index,'blue-z-periDS-pox']= z
    dfTidy.loc[group.index,'timeLock-z-periDS-pox']= timeLock
    
        #-- peri-DS lick
    z, timeLock=  zscoreCustom(group, 'reblue', 'lox', preEventTime, postEventTime,'DStime', baselineTime)
    dfTidy.loc[group.index,'blue-z-periDS-lox']= z
    dfTidy.loc[group.index,'timeLock-z-periDS-lox']= timeLock
