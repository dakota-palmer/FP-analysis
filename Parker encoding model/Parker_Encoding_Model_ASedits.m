...
figsave_folder='\\files.umn.edu\ahc\MNPI\neuroscience\labs\richard\Ally\Code\FP-analysis-variableReward\FP_analysis\FP-analysis\Parker encoding model\encoding_results\figs\40 Hz\movmean_ 12 to 2\';
...
%     gcamp_y_blue=data_to_input_GADVPFP.g_output(1).df;
    ...
    gcamp_y_blue_movmean=rmovmean( gcamp_y_blue,(12*fs),(2*fs));
    gcamp_y_purple_movmean=rmovmean( gcamp_y_purple,(12*fs),(2*fs));

    blue_movestd=rmovstd( gcamp_y_blue,(12*fs),(2*fs));
    purple_movestd=rmovstd( gcamp_y_purple,(12*fs),(2*fs));
...
%     set(gca, 'ytick', currentSubj(1).totalDScount); %label trials appropriately
    ...
    set(gcf,'Position', get(0, 'Screensize')); %make the figure full screen before saving
        ...
        figsave_name=strcat('ZTrials_Richard',subj_name,'.fig');
        cd(figsave_folder);
