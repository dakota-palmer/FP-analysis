...
#%% ---------------------------Supplemental FIG 3 Lick Count x Peri-PE CORRELATION ---------------



#%%--Load the data
datapath= r"C:\Users\Dakota\Documents\GitHub\FP-analysis\matlabVPFP\_dp_manuscript\vp-vta-fp_supplement_stats_fig3_correlation_lickCount_x_DSbluePox_Table.parquet"

df_supp_Fig3_lickCount_PE_corr= pd.read_parquet(datapath)


df= df_supp_Fig3_lickCount_PE_corr.copy()
...
print('saving df df_supp_Fig3_lickCount_PE_corr to file')

#Save as pickel
df.to_pickle(savePath+'supplement_Fig3_lickCount_PE_corr.pkl')
