...
%% Trial-based behavioral analyses

%-Code is pretty specific to our DS task / events / stages
% Assign events to trials (cue presentations)
% Compute PE Ratios, event latencies, etc.
