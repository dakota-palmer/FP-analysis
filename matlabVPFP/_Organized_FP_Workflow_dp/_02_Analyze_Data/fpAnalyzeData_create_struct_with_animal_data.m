%% 
% Imports subjDataRaw.mat file 
% Initializes subjDataAnzalyzed struct, where data will be stored
...
figPath= strcat(pwd,('\_output\_figures\'));

structPath= strcat(pwd,('\_output\'));
