...
disp(anovanTbl);
%in conclusion, for VPFP_quantNeuro dataset, with an alpha=.05 theres a significant main
%effect of cue identity (DS vs NS) and subject on the mean z score response
%to the cue in the 1s period following cue onset. There is also a
%significant interaction of cue*subject. The influence of subject makes
%sense given that expression levels and implant locations may vary between
%subjects, which lead to different baseline photometry signals.
