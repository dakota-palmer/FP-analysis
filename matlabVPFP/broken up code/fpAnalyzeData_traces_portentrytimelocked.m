...
%create vectors for all subjects for the DS
 ...
 %NS has different length vector, so need distinct variables for NS   
    if ~isnan(subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periNSpox.NSzpoxblueMean);
...
%          end
    ...
    pump1=repelem(1, length(subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxbluemeanPump1))';
    pump2=repelem(2,length(subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxbluemeanPump2))';
    pumpday=vertcat(pump1,pump2);
    pumpDS=vertcat(pumpDS,pumpday);
    
    pump1bluesignal= subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxbluemeanPump1;
    pump2bluesignal= subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxbluemeanPump2;
    pumpbluesignalday=vertcat(pump1bluesignal,pump2bluesignal);
    pumpbluesignalDS=vertcat(pumpbluesignalDS,pumpbluesignalday);
    
    pump1purplesignal= subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxpurplemeanPump1;
    pump2purplesignal= subjDataAnalyzed.(subjectsAnalyzed{subj})(day).periDSpox.DSzpoxpurplemeanPump2;
...
figure();
   ...
   a(1,1).set_names('x','Time from PE (sec)','y','Z-Score')
   a(1,1).set_title(' Average DS 465 nm Z Score-First Day of Training')
   a(1,1).axe_property('YLim',[-2 7])
   ...
   a(2,1).set_names('x','Time from PE (sec)','y','Z-Score')
   a(2,1).set_title(' Average DS 405 nm Z Score-First Day of Training')
   a(2,1).axe_property('YLim',[-2 7])
...
%Stage 5-day 1- when NS is introduced
   ...
   a(1,2).set_names('x','Time from PE (sec)','y','Z-Score')
   a(1,2).set_title(' Average DS 465 nm Z Score-NS Intro Day')
   a(1,2).axe_property('YLim',[-2 7])
   ...
   a(2,2).set_names('x','Time from PE (sec)','y','Z-Score')
   a(2,2).set_title(' Average DS 405 nm Z Score-NS Intro Day')
   a(2,2).axe_property('YLim',[-2 7])
 ...
 %Day animal reached criteria 
   ...
   a(1,3).set_names('x','Time from PE (sec)','y','Z-Score')
   a(1,3).set_title(' Average DS 465 nm Z Score-Day Reached Criteria')
   a(1,3).axe_property('YLim',[-2 7])
   ...
   a(2,3).set_names('x','Time from PE (sec)','y','Z-Score')
   a(2,3).set_title(' Average DS 405 nm Z Score-Day Reached Criteria')
   a(2,3).axe_property('YLim',[-2 7])
...
saveas(gcf, strcat(figPath,'AvgTraces_SEM_PElocked_Day1_Stage5Day1_Stage5CriteriaDay'),'fig');
%         close; %close 
...
figure();
   ...
   g(1,1).set_names('x','Time from PE (sec)','y','Z-Score')
   g(1,1).set_title(' Average DS 465 nm Z Score-Stage 1')
   g(1,1).axe_property('YLim',[-3 7])
   ...
   g(2,1).set_names('x','Time from PE (sec)','y','Z-Score')
   g(2,1).set_title(' Average DS 405 nm Z Score-Stage 1')
   g(2,1).axe_property('YLim',[-3 7])
...
%Stage 5
   ...
   g(1,2).set_names('x','Time from PE (sec)','y','Z-Score')
   g(1,2).set_title(' Average DS 465 nm Z Score-Stage 5')
   g(1,2).axe_property('YLim',[-3 7])
   ...
   g(2,2).set_names('x','Time from PE (sec)','y','Z-Score')
   g(2,2).set_title(' Average DS 405 nm Z Score-Stage 5')
   g(2,2).axe_property('YLim',[-3 7])
 ...
 %Satge 6
   ...
   g(1,3).set_names('x','Time from PE (sec)','y','Z-Score')
   g(1,3).set_title(' Average DS 465 nm Z Score-Stage 6')
   g(1,3).axe_property('YLim',[-3 7])
   ...
   g(2,3).set_names('x','Time from PE (sec)','y','Z-Score')
   g(2,3).set_title(' Average DS 405 nm Z Score-Stage 6')
   g(2,3).axe_property('YLim',[-3 7])
   ...
   g(1,4).set_names('x','Time from PE (sec)','y','Z-Score')
   g(1,4).set_title(' Average DS 465 nm Z Score-Stage 7')
   g(1,4).axe_property('YLim',[-3 7])
   ...
   g(2,4).set_names('x','Time from PE (sec)','y','Z-Score')
   g(2,4).set_title(' Average DS 405 nm Z Score-Stage 7')
   g(2,4).axe_property('YLim',[-3 7])
   ...
   g(1,5).set_names('x','Time from PE (sec)','y','Z-Score')
   g(1,5).set_title(' Average DS 465 nm Z Score-Stage 8')
   g(1,5).axe_property('YLim',[-3 7])
   ...
   g(2,5).set_names('x','Time from PE (sec)','y','Z-Score')
   g(2,5).set_title(' Average DS 405 nm Z Score-Stage 8')
   g(2,5).axe_property('YLim',[-3 7])
   ...
   %make figure full screen, save, and close this figure
set(gcf,'Position', get(0, 'Screensize')); %make the figure full screen before saving
saveas(gcf, strcat(figPath,'AvgTraces_SEM_PElocked_allstages'),'fig');
%         close; %close  
...
figure();
   ...
   k(1,1).set_names('x','Time from PE (sec)','y','Z-Score')
   ...
   k(2,1).set_names('x','Time from PE (sec)','y','Z-Score')
...
%pump2
   ...
   k(1,2).set_names('x','Time from PE (sec)','y','Z-Score')
   ...
   k(2,2).set_names('x','Time from PE (sec)','y','Z-Score')
   ...
   k.draw()
      ...
      %make figure full screen, save, and close this figure
set(gcf,'Position', get(0, 'Screensize')); %make the figure full screen before saving
saveas(gcf, strcat(figPath,'Stage8ProbetrialTraces_SEM_PElocked_stages'),'fig');
%         close; %close  