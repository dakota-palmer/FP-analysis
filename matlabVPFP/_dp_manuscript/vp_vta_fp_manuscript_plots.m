% Script for Palmer et al., 2023 manuscript photometry data figures 
%% 1- Load data from manuscript repo
...
%% 2- Run gramm configuration script for figures 

set_gramm_plot_defaults();

%% 3- set some other plot defaults
