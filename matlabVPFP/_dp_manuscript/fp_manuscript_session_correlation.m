...
%         y2= squeeze(currentSubj(session).periDS.DSzpurple(:,:,:));
        ...
        y1= squeeze(currentSubj(session).periDSpox.DSzpoxblue(:,:,:));
        y2= squeeze(currentSubj(session).periDSpox.DSzpoxpurple(:,:,:));
...
%         currentSubj(session).periDS.DSpurple(:,:,ind)= nan;
        ...
        currentSubj(session).periDSpoox.DSzpoxblue(:,:,ind)= nan;
        currentSubj(session).periDSpox.DSzpoxpurple(:,:,ind)= nan;
        currentSubj(session).periDSpox.DSpoxblue(:,:,ind)= nan;
        currentSubj(session).periDSpox.DSpoxpurple(:,:,ind)= nan;
...
%         y2= squeeze(currentSubj(session).periDS.DSzpurple(tsInd,:,:));
        ...
        y1= squeeze(currentSubj(session).periDSpox.DSzpoxblue(tsInd,:,:));
        y2= squeeze(currentSubj(session).periDSpox.DSzpoxpurple(tsInd,:,:));
...
%          corrTable(sesInd,"periDSzpurple")= {currentSubj(session).periDS.DSzpurpleMean};
         ...
         corrTable(sesInd,"periDSzblue")= {currentSubj(session).periDSpox.DSzpoxblueMean};
         corrTable(sesInd,"periDSzpurple")= {currentSubj(session).periDSpox.DSzpoxpurpleMean};
...
%          corrTable(sesInd,"periDSzpurpleAll")= {currentSubj(session).periDS.DSzpurple};
         ...
         corrTable(sesInd,"periDSblueAll")= {currentSubj(session).periDSpox.DSpoxblue};
         corrTable(sesInd,"periDSpurpleAll")= {currentSubj(session).periDSpox.DSpoxpurple};
...
% %       i.geom_line();
% 
%       i().set_color_options('map', mapCustomFP(3,:));        
...
%       i().set_color_options('map', mapCustomFP(2,:));        
...
% %       i.geom_line();
% 
%       i().set_color_options('map', mapCustomFP(5,:));        
%       i().set_line_options('base_size',0.5)
%       i.draw();
%       
...
% %       i.geom_line();
%       i.stat_summary('type','sem','geom','area');
%       i().set_color_options('map', mapCustomFP(6,:));        
%       i().set_line_options('base_size',1)    
%       
%       
...
%         i().stat_summary('type','sem', 'geom','area');
%         
%         i().set_color_options('map', mapCustomFP(1,:));        
...
%         i().stat_summary('type','sem', 'geom','area');
%         
%         i().set_color_options('map', mapCustomFP(7,:));        
%         i().set_line_options('base_size',2)        
%          
