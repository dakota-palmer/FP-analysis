...
subjects = 1% [1,2,3,4,5]%:278; %only one example file was included- I think there should be 1 file per subject...I guess in our case it's 1 per subj -dp


for subject=1:numel(subjects)
    
    clearvars -except curr_dir save_folder condition subjects subject
